...
describe('Slippage Protection System', () => {
    describe('calculateSwapOutput', () => {
        ...
        it('should handle different fee percentages', () => {
            const noFee = (0, protection_1.calculateSwapOutput)({
                reserveIn: '1000',
                reserveOut: '1000',
                amountIn: '100',
                feePercent: 0,
            });
            const withFee = (0, protection_1.calculateSwapOutput)({
                reserveIn: '1000',
                reserveOut: '1000',
                amountIn: '100',
                feePercent: 0.25,
    ...
    describe('calculatePriceImpact', () => {
        it('should calculate price impact correctly', () => {
            const impact = (0, protection_1.calculatePriceImpact)({
                reserveIn: '10000',
                reserveOut: '10000',
                amountIn: '100',
            });
        ...
        it('should correctly classify risk levels', () => {
            ...
            const small = (0, protection_1.calculatePriceImpact)({
                reserveIn: '1000000',
                reserveOut: '1000000',
                amountIn: '100',
            });
            ...
            const large = (0, protection_1.calculatePriceImpact)({
                reserveIn: '1000',
                reserveOut: '1000',
                amountIn: '500',
            });
    ...
    describe('validateSlippage', () => {
        it('should validate acceptable slippage', () => {
            const result = (0, protection_1.validateSlippage)('100', '99', '98.5', 1.0);
            expect(result.valid).toBe(true);
            expect(result.riskLevel).toBeDefined();
        });
        it('should reject excessive slippage', () => {
            const result = (0, protection_1.validateSlippage)('100', '99', '85', // Huge loss
            1.0);
            expect(result.valid).toBe(false);
            expect(result.warning).toBeDefined();
        });
        it('should provide warnings near limit', () => {
            const result = (0, protection_1.validateSlippage)('100', '99', '91', // 9% loss
            10.0);
    ...
    describe('analyzeTradesafety', () => {
        it('should classify safe trade', () => {
            const priceImpact = (0, protection_1.calculatePriceImpact)({
                reserveIn: '1000000',
                reserveOut: '1000000',
                amountIn: '100',
            });
            const slippageValidation = (0, protection_1.validateSlippage)('100', '99', '98', 0.5);
            const safety = (0, protection_1.analyzeTradesafety)(priceImpact, slippageValidation, '2000000');
        ...
        it('should warn about high price impact', () => {
            ...
            const slippageValidation = (0, protection_1.validateSlippage)('500', '250', '200', 50);
            const safety = (0, protection_1.analyzeTradesafety)(priceImpact, slippageValidation, '1000');
        ...
        it('should detect large trades', () => {
            ...
            const slippageValidation = (0, protection_1.validateSlippage)('200', '100', '90', 50);
            const safety = (0, protection_1.analyzeTradesafety)(priceImpact, slippageValidation, '1000');
    ...
    describe('recommendSlippageTolerance', () => {
        it('should recommend appropriate tolerance for low impact', () => {
            const tolerance = (0, protection_1.recommendSlippageTolerance)(0.1);
            expect(tolerance).toBeLessThan(1);
            expect(tolerance).toBeGreaterThan(0);
        });
        it('should recommend higher tolerance for high impact', () => {
            const lowImpact = (0, protection_1.recommendSlippageTolerance)(0.1);
            const highImpact = (0, protection_1.recommendSlippageTolerance)(3);
            expect(highImpact).toBeGreaterThan(lowImpact);
        });
        it('should apply volatility multiplier', () => {
            const normal = (0, protection_1.recommendSlippageTolerance)(1, 1); // Normal volatility
            const volatile = (0, protection_1.recommendSlippageTolerance)(1, 2); // High volatility
